...
module.exports = {
    formatWoodstoveState: (value) => {
        ...
        return `<span style="background-color: ${bgColor}; color: ${textColor}; padding: 2px 8px; border-radius: 4px; font-weight: bold; display: inline-block;">${label}</span>`;
    },
    ...
    formatTemperature: (value) => {
        ...
        return `<span style="background-color: ${bgColor}; color: ${textColor}; padding: 2px 8px; border-radius: 4px; font-weight: bold; display: inline-block;">${temp.toFixed(1)}°C</span>`;
    },
    ...
    formatLeadAcidBatteryVoltage: (value) => {
        ...
        return `<span style="background-color: ${bgColor}; color: ${textColor}; padding: 2px 8px; border-radius: 4px; font-weight: bold; display: inline-block;">${voltage.toFixed(2)}V</span>`;
    }
};